...
$modal_title = __('Clone Ticket','wp-support-plus-responsive-ticket-system');
...
<form id="frm_edit_clone_subject">
    ...
    <input type="hidden" name="action" value="wpsp_set_clone_ticket" />
...
<div class="row">
    <div class="col-md-12" style="text-align: right;">
        ...
        <button type="button" class="btn btn-primary" onclick="set_clone_ticket();"><?php _e('Save Changes','wp-support-plus-responsive-ticket-system');?></button>
    </div>
</div>
