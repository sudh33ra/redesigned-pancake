...
$modal_title = __('Permanent Delete Ticket','wp-support-plus-responsive-ticket-system');

ob_start();

?>

<form id="frm_permanent_delete_ticket">
    
    <div class="form-group">
        <p><?php _e('Are you sure?','wp-support-plus-responsive-ticket-system');?></p>
    </div>
    
    <input type="hidden" name="action" value="wpsp_set_permanent_delete_ticket" />
...
<div class="row">
    <div class="col-md-12" style="text-align: right;">
        ...
        <button type="button" class="btn btn-primary" onclick="set_permanent_delete_ticket();"><?php _e('Confirm','wp-support-plus-responsive-ticket-system');?></button>
