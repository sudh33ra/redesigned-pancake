...
<div id="tab_container">
    ...
    <form id="wpsp_frm_general_spm_menu" method="post" action="#" onsubmit="return validate_add_support_menu(this);">
        ...
        <table class="form-table">
            ...
            <tr>
              ...
              <td>
                <input type="text" class="required" id="support_menu_name" name="wpsp_sp_menu[name]" value="">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <img id="wpsp_support_menu_img" style="width: 100px;" /><br>
                ...
                <input id="wpsp_support_menu_img_url"  type="hidden" name="wpsp_sp_menu[img_url]" />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type="text" class="required"  id="support_page_menu_url" name="wpsp_sp_menu[url]" value="">
              </td>
            </tr>
        </table>

        <input type="hidden" name="action" value="update"/>
        <input type="hidden" name="update_setting" value="support_page_menu_add"/>
        ...
        <p class="submit">
            ...
            <a href="<?php echo htmlentities($section_list_href);?>" class="button button-primary" type="button"> <?php _e('Cancel','wp-support-plus-responsive-ticket-system')?></a>				
        </p>
...
function validate_add_support_menu(obj){
	var flag=true;
